...
namespace Foog.Core.Utilities.Encryption
{
    /// <summary>
    /// JWT 加解密
    /// </summary>
    public class JWTEncryption
    {
        ...
        public JWTEncryption(IOptions<JWTOptions> options)
        {
            _options = options;
        }
        ...
        /// <returns></returns>
        public string Encrypt(Dictionary<string, object> payload, long? expiredTime = null)
        {
        ...
        /// <param name="payload"></param>
        /// <returns></returns>
        public string Encrypt(string issuerSigningKey, Dictionary<string, object> payload)
        {
        ...
        /// <param name="payload"></param>
        /// <returns></returns>
        public string Encrypt(string issuerSigningKey, string payload)
        {
        ...
        /// <returns></returns>
        public string GenerateRefreshToken(string accessToken, int days = 30)
        {
            // 分割Token
        ...
        /// <param name="expiredTime"></param>
        /// <returns></returns>
        public string Exchange(string expiredToken, string refreshToken, long? expiredTime = null)
        {
            // 判断刷新Token 是否过期
        ...
        /// <param name="days"></param>
        /// <returns></returns>
        public bool AutoRefreshToken(AuthorizationHandlerContext context, DefaultHttpContext httpContext, long? expiredTime = null, int days = 30)
        {
            // 如果验证有效，则跳过刷新
        ...
        /// <param name="accessToken"></param>
        /// <returns></returns>
        public (bool IsValid, JsonWebToken Token) Validate(string accessToken)
        {
        ...
        /// <param name="headerKey"></param>
        /// <returns></returns>
        public string GetJwtBearerToken(DefaultHttpContext httpContext, string headerKey = "Authorization")
        {
        ...
        /// <returns></returns>
        public TokenValidationParameters CreateTokenValidationParameters(JWTOptions jwtSettings)
        {
        ...
        /// <returns></returns>
        private (Dictionary<string, object> Payload, JWTOptions JWTSettings) CombinePayload(Dictionary<string, object> payload, long? expiredTime = null)
        {
        ...
        /// 固定的 Claim 类型
        /// </summary>
        private readonly string[] StationaryClaimTypes = new[] { JwtRegisteredClaimNames.Iat, JwtRegisteredClaimNames.Nbf, JwtRegisteredClaimNames.Exp, JwtRegisteredClaimNames.Iss, JwtRegisteredClaimNames.Aud };
