...
namespace Foog.Core.Utilities
{
    /// <summary>
    /// 应用文件帮助类
    /// <para>当前path为<see cref="Directory.GetCurrentDirectory()"/></para>
    /// </summary>
    public class FileAppHelper
    {
        /// <summary>
        /// 程序目录
        /// </summary>

        private readonly static string _path = Directory.GetCurrentDirectory();
        ...
        public static void CreateFile(string dir, string pagestr, string path = null)
        {
            ...
            StreamWriter sw = new StreamWriter(path + "\\" + dir, false, System.Text.Encoding.GetEncoding("GB2312"));
            sw.Write(pagestr);
            sw.Close();
        }
        /// <summary>
        ...
        #region 本地路径
        /// <summary>
        /// 本地路径  <see cref="Directory.GetCurrentDirectory()"/>
        /// </summary>
